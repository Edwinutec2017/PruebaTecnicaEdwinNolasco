...
namespace Services
{
    public class TransaccionesService : ITransaccionesService
    {
        ...
        public async Task<string> AddComprasCliente(TransaccionesDto compras)
        {
            string compra="";

            string endpoint = $"{_endpointsDto.UrlBackenApi}TransaccionesClientes/TransaccionAddCompras";
